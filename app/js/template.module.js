...
var templateModule = (function(){
  var template = {
    templates : {
      'boundary-result-view'       : [
      '<article class="title">',1,'</article>',
      '<article class="survey-btn"><article class="form-btn" onclick="survey.startSurvey()">START SURVEY</article></article>',
      '<article id="geocoder" class="geocoder"></article>',
      '<article class="total-rentals"><h4>TOTAL PROPERTIES</h4><p>',6,'</p></article>',
      '<article class="overall-number">',9,'</article>',
